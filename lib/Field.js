...
var Field = /** @class */ (function (_super) {
    ...
    Field.prototype.render = function () {
        var _a = this.props, formValue = _a.formValue, stringToFormValue = _a.stringToFormValue, Component = _a.component, _b = _a.fieldInputProps, fieldInputProps = _b === void 0 ? {} : _b, disabled = _a.disabled, rest = __rest(_a, ["formValue", "stringToFormValue", "component", "fieldInputProps", "disabled"]);
        var hasError = formValue.isTouched && !lodash_1.isEmpty(formValue.errors);
        return (React.createElement(Component, __assign({}, rest, { disabled: formValue.disabled || disabled, input: __assign({}, fieldInputProps, { onBlur: this.handleBlur, onFocus: this.handleFocus, onChange: this.handleChange, value: formValue.value }), errors: hasError ? formValue.errors : undefined })));
    };
    Field = __decorate([
