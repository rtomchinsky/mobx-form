...
var Field = /** @class */ (function (_super) {
    ...
    Field.prototype.render = function () {
        ...
        return (React.createElement(Component, __assign({}, rest, { disabled: formValue.disabled, input: __assign({}, fieldInputProps, { onBlur: this.handleBlur, onFocus: this.handleFocus, onChange: this.handleChange, value: formValue.value }), errors: hasError ? formValue.errors : undefined })));
    };
    Field = __decorate([
