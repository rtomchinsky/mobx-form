...
var FormValue = /** @class */ (function () {
    function FormValue(options) {
        ...
        this.validationSubject.asObservable()
            .switchMap(mobx_1.action(function (form) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            var errors, result;
    ...
    FormValue.prototype.update = function (form) {
    ...
    FormValue.prototype.validate = function (form) {
    ...
    __decorate([
        mobx_1.observable,
        __metadata("design:type", Boolean)
    ], FormValue.prototype, "enabled", void 0);
    __decorate([
        mobx_1.computed,
        __metadata("design:type", Object),
